...
if ($label != 'pie') { ?>
<p class="w3-attr">Much information in this CSS reference has been gathered from the <a target='_blank' href='http://www.w3schools.com/css/css_reference_atoz.asp'>W3 Schools CSS Reference.</a></p>
<?php } ?>
...
$ref['font']['font_style'] = array(
	'title' => 'Font Style', 
	'desc' => "The font-style property specifies the font style for text.",
	'values' => array(
...
$ref['font']['font_variant'] = array(
	'title' => 'Font Variant', 
	'desc' => "The font-variant property specifies whether or not text should be displayed in a small-caps font.",
	'values' => array(
...
$ref['text']['text_shadow_color'] = array(
	...
	'desc' => "The color of the text shadow.",
	'values' => array(
...
$ref['text']['text_shadow_x'] = array(
	...
	'desc' => "The position of the horizontal shadow. Negative values are allowed",
	'values' => array(
...
$ref['text']['text_shadow_y'] = array(
	...
	'desc' => "The position of the vertical shadow. Negative values are allowed",
	'values' => array(
...
$ref['text']['text_shadow_blur'] = array(
	...
	'desc' => "The blur distance. If you define a black text shadow and a blur of 3px, their will be a 3 pixel blur area where the shadow fades evenly from black to transparent.",
	'values' => array(
		"(numeric)" => "e.g. '4' would create a 4 pixel text blur."), 
	'w3s' => '');
/*** Color ***/
// color
$ref['forecolor']['color'] = array(
...
$ref['background']['background_position_x'] = array(
	...
	'desc' => "The horizontal (x-axis) position of the background image. This property sets the left edge of a background image to a unit to the 
...
$ref['background']['background_position_y'] = array(
	...
	'desc' => "The vertical (y-axis) position of the background image. This property sets the top edge of a background image to a unit above or below the top edge of the element the background image is being applied to. Negative values are allowed.</p>
...
$ref['dimensions']['width'] = array(
	'title' => 'Width', 
	'desc' => "The width property sets the width of an element. <b>Note:</b> The total width of an element is 
...
$ref['dimensions']['height'] = array(
	'title' => 'Height', 
	'desc' => "The height property sets the height of an element. <b>Note:</b> The total height of an element is 
...
$ref['dimensions']['min_width'] = array(
	'title' => 'Minimum Width', 
	'desc' => "The min-width property sets the minimum width of an element. Note: The min-width property does not include padding, borders, or margins",
	'values' => array(
...
$ref['dimensions']['min_height'] = array(
	...
	'desc' => "The min-height property sets the minimum height of an element. Note: The min-height property does not include padding, borders, or margins",
	'values' => array(
...
$ref['dimensions']['max_width'] = array(
	'title' => 'Maximum Width', 
	'desc' => "The max-width property sets the maximum width of an element. Note: The max-width property does not include padding, borders, or margins",
	'values' => array(
...
$ref['dimensions']['max_height'] = array(
	...
	'desc' => "The max-height property sets the maximum height of an element. Note: The max-height property does not include padding, borders, or margins",
	'values' => array(
...
$ref['border']['border_style'] = array(
	'title' => 'Border Style', 
	'desc' => "The border-style property sets the style of an element's four borders.",
	'values' => array(
...
$ref['behaviour']['display'] = array(
	'title' => 'Display', 
	'desc' => "The display property specifies the type of box an element should generate.",
	'values' => array(
...
$ref['behaviour']['clear'] = array(
	'title' => 'Clear', 
	'desc' => "The clear property specifies which sides of an element where other floating elements are not allowed.",
	'values' => array(
...
$ref['behaviour']['visibility'] = array(
	'title' => 'Visibility', 
	'desc' => "The visibility property specifies whether or not an element is visible. But unlike setting 'display' to 'none', if you set 'visibility' to 'hidden' the hidden element will still take up the same space on the page - it just won't be visible.",
	'values' => array(
...
$ref['position']['position'] = array(
	'title' => 'Position', 
	'desc' => "The position property is used to position an element.",
	'values' => array(
...
$ref['position']['left'] = array(
	'title' => 'Left', 
	'desc' => "For absolutely positioned elements, the left property sets the left edge of an element to a unit to the 
...
$ref['CSS3']['gradient_a'] = array(
	'title' => 'Gradient A', 
	'desc' => "One of the colors in the linear gradient. The color you specify here will gradually blend into the color you specify for Gradient B if you specify one. If you don't specify a color for Gradient B, Gradient A will blend into Gradient C.",
	'values' => array(
...
$ref['CSS3']['gradient_c'] = array(
	'title' => 'Gradient C', 
	'desc' => "One of the colors in the linear gradient. The color you specify here will gradually blend into the color you specify for Gradient B if you specify one. If you don't specify a color for Gradient B, Gradient C will blend into Gradient A.",
	'values' => array(
...
$ref['CSS3']['gradient_angle'] = array(
	...
	'desc' => "The angel of the gradient. You have 8 options which cover all possible horizontal, vertical and perfectly diagonal variations. Note: old versions of Safari and Chrome (< Chrome 10 and < Safari 5.1) don't properly support diagonal gradients.",
	'values' => array(
...
$ref['CSS3']['box_shadow_color'] = array(
	...
	'desc' => "The color of the shadow. Choosing a darker version of the parent element's background color produces the most natural effect.",
	'values' => array(
		"(hex code)" => "Microthemer provides a color picker for specifying color without having to remember hex codes. Just click your mouse in the Color text field to reveal the color picker."), 
	'w3s' => '');	
// box shadow x offset
...
$ref['CSS3']['box_shadow_blur'] = array(
	...
	'desc' => "The blur distance. If you defined a black shadow and a blur of 10px, their would be a 10 pixel blur area where the shadow faded evenly from black to transparent at every extremity.",
	'values' => array(
...
// else just get the snippet
	...
	// else property explanation
		...
		<div id='<?php echo $label; ?>' class='snippet content-box'>
            ...
            <div class="inner-box">
			<p><?php echo $ref[$prop_group][$label]['desc']; ?></p>
			<table>
			 <thead>
			 <tr class='heading'>
			 ...
			 <?php
			 $i = 1;
			 foreach ($ref[$prop_group][$label]['values'] as $value => $desc) {
				?>
